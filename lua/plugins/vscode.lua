...
vim.api.nvim_create_autocmd("User", {
  ...
  callback = function()
    ...
    keymap("n", "<leader>h", function()
      vscode.action("cursor-harpoon.editorQuickPick")
    end, { desc = "Harpooon Quick Menu" })
    keymap("n", "<leader>H", function()
      vscode.action("cursor-harpoon.addEditor")
    end, { desc = "Harpooon Add Editor" })
    keymap("n", "<leader>1", function()
      vscode.action("cursor-harpoon.gotoEditor1")
    end)
    keymap("n", "<leader>2", function()
      vscode.action("cursor-harpoon.gotoEditor2")
    end)
    keymap("n", "<leader>3", function()
      vscode.action("cursor-harpoon.gotoEditor3")
    end)
    keymap("n", "<leader>4", function()
      vscode.action("cursor-harpoon.gotoEditor4")
    end)
    keymap("n", "<leader>5", function()
      vscode.action("cursor-harpoon.gotoEditor5")
    end)
    keymap("n", "<leader>6", function()
      vscode.action("cursor-harpoon.gotoEditor6")
    end)
    keymap("n", "<leader>7", function()
      vscode.action("cursor-harpoon.gotoEditor7")
    end)
    keymap("n", "<leader>8", function()
      vscode.action("cursor-harpoon.gotoEditor8")
    end)
    keymap("n", "<leader>9", function()
      vscode.action("cursor-harpoon.gotoEditor9")
    end)
  end,
})
return {}
